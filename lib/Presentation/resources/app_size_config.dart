...
class SizeConfig extends StatelessWidget {
  ...
  static double headline1Size = SizeConfig.height * 0.0585; //50px
  //#endregion

  //#region headline 2 Size
  static double headline2Size = SizeConfig.height * 0.0351; //30 px
//#endregion

  //#region headline 3 Size
  static double headline3Size = SizeConfig.height * 0.032; //27 px
//#endregion

  //#region headline 4 Size
  static double headline4Size = SizeConfig.height * 0.0235 ; //20 px
//#endregion

  //#region headline 5 Size
  static double headline5Size = SizeConfig.height * 0.020 ; //18 px
//#endregion

  //#region headline 6 Size
  static double headline6Size = SizeConfig.height * 0.0194 ; //16 px
//#endregion

  //#region headline 7 Size
  static double headline7Size = SizeConfig.height * 0.012 ; //12 px
//#endregion
